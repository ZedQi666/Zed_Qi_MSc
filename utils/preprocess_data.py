...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--source',
                        ...
                        required=False,
                        default=r"D:\FJX\其他\gector-master\dev_texts\incorr_sentences.txt")
    parser.add_argument('-t', '--target',
                        help='Path to the target file',
                        required=False,
                        default=r"D:\FJX\其他\gector-master\dev_texts\corr_sentences.txt")
    parser.add_argument('-o', '--output_file',
                        help='Path to the output file',
                        required=False,
                        default=r"D:\FJX\其他\gector-master\dev.txt")
